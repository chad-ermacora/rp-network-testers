...
# Custom Kootnet Network Testers import
...
try:
    ...
    def print_(*args, **kwargs):
        ...
        if kwargs.get('file') == sys.stderr:
            ...
            write_file_to_disk(test_file_location, final_msg, open_type="a")
            app_variables.raw_internet_speed_test_results += final_msg
